...
void solver_sholesky(float **matrix,float *solus_x, float *b, int n){
  int i, j;
...
int main()
{
  ...
  matrix[0][0] = 64; matrix[0][1] = 40; matrix[0][2] = 24;
  matrix[1][0] = 40; matrix[1][1] = 29; matrix[1][2] = 17;
  matrix[2][0] = 24; matrix[2][1] = 17; matrix[2][2] = 19;
  solver_sholesky(matrix, solus, b, LEN);
  for (i = 0; i < LEN; i++) {
    printf("%f\n", solus[i]);
  }
  /*FREE*/
